...
class ResponseSerializer:
    ...
    def success(
        ...
        response_data = SuccessResponse[T](
            data=data, message=message, meta=meta, request_id=request_id
        )
    ...
    def paginated(
        ...
        response_data = PaginatedResponse[T](
            data=items, message=message, pagination=pagination, request_id=request_id
        )

        return JSONResponse(
            status_code=200, content=response_data.dict_with_encoders(exclude_none=True)
        )
    ...
    def created(
        ...
        return ResponseSerializer.success(
            data=data, message=message, status_code=201, request_id=request_id
        )
    ...
    def no_content(
        ...
        return ResponseSerializer.success(
            message=message, status_code=204, request_id=request_id
        )
