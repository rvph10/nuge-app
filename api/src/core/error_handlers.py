...
from .response import ErrorDetail, ResponseSerializer
...
async def validation_exception_handler(
    ...
    for error in exc.errors():
        ...
        errors.append(
            ErrorDetail(field=field_name, message=error["msg"], code=error["type"])
        )
    ...
    return ResponseSerializer.validation_error(
        errors=errors, message="Request validation failed", request_id=request_id
    )
...
async def pydantic_validation_exception_handler(
    ...
    return ResponseSerializer.validation_error(
        errors=errors, message="Data validation failed", request_id=request_id
    )
